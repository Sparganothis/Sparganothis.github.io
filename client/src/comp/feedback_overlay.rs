        ...
        view! {
            <div style="display:flex; flex-direction:row;height:100%;width:25%;cursor:pointer;">
                ...
                <div
                    ...
                    on:click=move |_| value.set(n4.clone())
                >
...
pub fn FeedbackButtonExpander()->impl IntoView {
    ...
    view! {
        <div
            style="position:absolute;right:1vmin;bottom:1vmin;width:14vmin;height:5vmin;z-index:2999;border:1vmin solid black; background-color:white;padding:0.1vmin;margin:0.1vmin;cursor: pointer;"
            on:click=on_click
        >
...
pub fn FeedbackOverlayForm()->impl IntoView {
    ...
    view! {
        ...
        <div style="height:24%;width:100%">
            <textarea
                style="width:80%;height:80%;padding:5%;margin:5%;"
