        ...
        <table>
            ...
            <tr>
                <td style="width:20vmin;">
                    <Toggle state=user_setting_signal.sound_enabled.read_only() set_state=user_setting_signal.sound_enabled.write_only()/>
                </td>
                ...
                <td style="width:20vmin;">
                    <h3>
                        {move || {
                            (if user_setting_signal.sound_enabled.get() { "ON" } else { "OFF" }).to_string()
                        }}
            ...
            <Show when=move|| user_setting_signal.sound_enabled.get() >
                ...
                <tr>
                    <td>
                        {move|| if user_setting_signal.sound_enabled.get() {
                                    view!{<Slider
                                    disabled=true
                                    min=1.0
                                    max=100.0
                ...
                <tr>
                    <td>
                        <Toggle state=user_setting_signal.sound_menu_music_enabled.read_only() set_state=user_setting_signal.sound_menu_music_enabled.write_only()/>
                    </td>
                    <td>
                        <h3>Menu Music</h3>
                    </td>
                    <td>
                        <h3>
                            {move || {
                                (if user_setting_signal.sound_menu_music_enabled.get() { "ON" } else { "OFF" }).to_string()
                            }}
                ...
                <Show when=move|| has_cchanged_menu.get()                >
                    ...
                    <tr>   <td colspan="100%">  <h5 style="color:red; font-weight: bold;"> This setting may require refresh </h5> </td> </tr>
                </Show>
